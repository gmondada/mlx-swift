...
let noCudaCmlxExcludes = [
    ...
    "mlx/mlx/backend/cuda/unary",
        ...
        let cxxSettings: [CXXSetting] = [
            .unsafeFlags(["-I/usr/local/cuda-13.2/include"]),
            .unsafeFlags(["-I/usr/local/cuda-13.2/targets/sbsa-linux/include"]),
            .unsafeFlags(["-I/usr/local/cuda-13.2/targets/sbsa-linux/include/cccl"]),
        ]
        ...
        let linkerSettings: [LinkerSetting] = [
            ...
            .unsafeFlags(["-L/usr/local/cuda/targets/aarch64-linux/lib"]),
            .unsafeFlags(["-L/usr/local/cuda/targets/sbsa-linux/lib"]),
            .unsafeFlags(["-L/usr/local/cuda-13.2/targets/sbsa-linux/lib"]),
            .unsafeFlags(["-L/usr/local/cuda-13.2/targets/sbsa-linux/lib/stubs"]),
            .linkedLibrary("cudnn"),
        ...
        ] + noMetalExcludes + noCudaExcludes
